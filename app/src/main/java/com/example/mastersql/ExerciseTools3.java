...
public class ExerciseTools3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_tools3);
        intialize();
    }
    ...
    public void onClick(View view) {
        ...
        {
            ckOracle.setBackgroundResource(R.drawable.border_right_answer);
        ...
        if (id == btnNext.getId())
        {
            Intent intent = new Intent(this, ExerciseTools4.class);
